...
import com.uce.edu.demo.tarea16_25.service.IMatriculaGestorService;
import com.uce.edu.demo.tarea16_25.service.IPropietarioService;
import com.uce.edu.demo.tarea16_25.service.IVehiculoService;
...
public class ProyectoU2AfApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		vehiculo.setPlaca("PCH8673");
		vehiculo.setPrecio(new BigDecimal(5500));
		vehiculo.setTipo("P");
